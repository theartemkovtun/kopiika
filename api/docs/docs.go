...
const docTemplate = `{
    ...
    "paths": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schemas.UpdateAccountSchema"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/templates": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/schemas.TransactionTemplateSchema"
                            }
                        }
                    },
                    "401": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Template id and fields to update",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schemas.UpdateTransactionTemplateSchema"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schemas.CreateTransactionTemplateSchema"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "type": "string",
                        "description": "Only income or only outcome",
                        "name": "type",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Matches anywhere in the title, case-insensitively",
                        "name": "search",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Earliest day to include (YYYY-MM-DD)",
                        "name": "fromDate",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Latest day to include (YYYY-MM-DD)",
                        "name": "toDate",
                        "in": "query"
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "collectionFormat": "multi",
                        "description": "Only these accounts",
                        "name": "accountIds",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/schemas.PaginatedResponse-schemas_DateTransactionsSchema"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schemas.UpdateTransactionSchema"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/schemas.CreateTransactionSchema"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/schemas.TransactionsConfigurationSchema"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/v1/transactions/date/{date}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Day to fetch (YYYY-MM-DD)",
                        "name": "date",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/schemas.DateTransactionsSchema"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "boolean",
                        "default": false,
                        "description": "Also report the counts, averages, extremes and account breakdowns",
                        "name": "full",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/schemas.TransactionsStatisticsSchema"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "schemas.AccountStatisticsSchema": {
            "type": "object",
            "properties": {
                "colorHex": {
                    "type": "string",
        ...
        "schemas.AccountTransactionCountSchema": {
            "type": "object",
            "properties": {
                "colorHex": {
                    "type": "string",
        ...
        "schemas.CategoryStatisticsSchema": {
            "type": "object",
            "properties": {
                "hexColor": {
                    "type": "string",
        ...
        "schemas.CategoryTransactionCountSchema": {
            "type": "object",
            "properties": {
                "hexColor": {
                    "type": "string",
        ...
        "schemas.CreateTransactionSchema": {
            ...
            "properties": {
                ...
                "value": {
                    "description": "Value is a pointer so that a missing value is rejected while an explicit\nzero is still accepted, as in Python.",
                    "type": "string",
                    "example": "125.40"
                },
                "year": {
        ...
        "schemas.CreateTransactionTemplateSchema": {
            "type": "object",
            "required": [
                "title",
                "value"
            ...
            "properties": {
                ...
                "value": {
                    "description": "Value is the client's serialized transaction form; the API does not read it.",
                    "type": "string",
                    "example": "{\"type\":\"outcome\",\"value\":\"85\",\"currency\":\"uah\"}"
                }
            }
        },
        ...
        "schemas.DateTransactionsSchema": {
            "type": "object",
            "properties": {
                "date": {
                    "type": "string",
        ...
        "schemas.PaginatedResponse-schemas_DateTransactionsSchema": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
        ...
        "schemas.TransactionSchema": {
            ...
            "properties": {
                "account": {
                    "$ref": "#/definitions/schemas.AccountBaseSchema"
                },
                "amount": {
                    "$ref": "#/definitions/schemas.AmountSchema"
                },
                ...
                "localizedAmount": {
                    "description": "LocalizedAmount is Amount converted into the user's own currency at the\nrate for the transaction's own date, not today's.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/schemas.AmountSchema"
                        }
                ...
                "tags": {
                    "description": "Tags is always empty: tags are not ported yet, and the key is kept so the\nresponse shape stays the one the clients already read.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "title": {
                    "description": "Title and Description are what the user typed, not a derived label.",
                    "type": "string",
                    "example": "Groceries"
                },
                "type": {
        ...
        "schemas.TransactionTemplateSchema": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "string",
        ...
        "schemas.TransactionsConfigurationSchema": {
            "type": "object",
            "properties": {
                "accounts": {
                    "type": "array",
        ...
        "schemas.TransactionsStatisticsSchema": {
            "type": "object",
            "properties": {
                "accountOutcomeStatistics": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/schemas.AccountStatisticsSchema"
                    }
                },
                "accountOutcomeTransactions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/schemas.AccountTransactionCountSchema"
                    }
                },
                "averageIncome": {
                    "$ref": "#/definitions/schemas.AmountSchema"
                ...
                "categoryOutcomeStatistics": {
                    "description": "CategoryOutcomeStatistics is spending per category, largest first.\nTransactions with no category are left out rather than pooled.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/schemas.CategoryStatisticsSchema"
                    }
                },
                "categoryOutcomeTransactions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/schemas.CategoryTransactionCountSchema"
                    }
                },
                "difference": {
                ...
                "rangeStatistics": {
                    "description": "RangeStatistics covers every day in the range, oldest first.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/schemas.DateStatisticsSchema"
                    }
                },
                "totalTransactions": {
                    "type": "integer",
        ...
        "schemas.UpdateTransactionSchema": {
            "type": "object",
            "required": [
                "currency",
                "id",
        ...
        "schemas.UpdateTransactionTemplateSchema": {
            "type": "object",
            "required": [
                "id"
            ],
